							...
							<div class="slip-manager">
								...
								<div class="slip-manager-nei">
									...
									<div style="margin-top: .16rem;">
										<span class="slip-manager-bot size" >保险期限:<span class="slip-manager-bot-left">{{$res['tka_accidentDate'].'  07:00:00'}}至{{$res['tka_accidentDate'].'  23:59:59'}}</span></span>
									</div>
									<div style="margin-top: .16rem;">
			...
			<div class="mui-content" style="background-color: #efeff4;">
				<div id="slider1" class="swipe">
					<div class="shixiao">
						...
						<div class="shixiao-head1">
							<span >出险日期:</span><span>{{$res['claim_date']}}</span>
						</div>
					</div>
					<div class="color">
					</div>
							...
							<div class="slip-left">
								<div class="slip-manager">
									...
									<div class="slip-manager-nei">
										...
										<div style="margin-top: .16rem;">
											<span class="slip-manager-bot size" >保险期限:<span class="slip-manager-bot-left">{{$res['claim_date'].'  07:00:00'}}至{{$res['claim_date'].'  23:59:59'}}</span></span>
										</div>
										<div style="margin-top: .16rem;">
											<span class="slip-manager-bot size" >报案号:<span class="slip-manager-bot-left">{{$res['claim_id']}}</span></span>
										</div>
