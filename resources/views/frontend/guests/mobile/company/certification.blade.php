            ...
            <div class="mui-scroll">
                <div class="applicant-wrapper">
                    <ul class="applicant-partone">
                        <li>
                            <span class="name">企业名称</span><input id="name" name="name" type="text" placeholder="请填写"/>
                        </li>
                        ...
                        <li class="hide">
                            <span class="name">组织机构代码</span><input id="organizationCode" type="text" value="" name="code" placeholder="请填写"/>
                        </li>
                        <li class="hide">
                            <span class="name">营业执照编号</span><input id="licenseNumber" type="text" value="" name="license_code" placeholder="请填写"/>
                        </li>
                        <li class="hide">
                            <span class="name">纳税人识别号</span><input id="identifyNumber" type="text" value="" name="tax_code" placeholder="请填写"/>
                        </li>
                        <li>
                            <span class="name">统一信用代码</span><input id="creditCode" type="text" value="" name="credit_code" placeholder="请填写"/>
                        </li>
                        <li class="pickerfour">
                        ...
                        <li>
                            ...
                            <input id="address" type="text" value="" name="inAddress" placeholder="请填写"/>
                        </li>
                        <li>
