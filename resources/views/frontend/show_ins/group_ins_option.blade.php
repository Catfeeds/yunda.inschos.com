...
<div class="cont-main-contentr">
    <div class="contentrs">
        ...
        <ul class="formd">
            ...
            <li>
                <input type="text" name="count_people" value="" />
                <span>人</span>
            </li>
            <li>
                <span>保费</span><span style="color: #00a2ff;" id="price">{{$price/ 100 }}</span>元/人
            </li>
            <li>
                <span>保费共计:</span><span style="color: #00a2ff;" id="count"></span>
            </li>
        </ul>
        <button disabled>立即投保</button>
    </div>
</div>
    ...
    function aaa(){
        ...
        inputs.each(function(index){
            ...
            if(index == inputs.length-1){
                $("#count").html($('#price').html() * (inputs.length)+'元');
                btn.disabled = false;
            }
        });
    }
