	...
	<div class="mui-inner-wrap">
								...
								<div class="mui-scroll-wrapper">
									<div id="scroll1" class="mui-scroll">
										<div class="product-wrapper">
													...
													@endphp
													<div class="product-item clearfix">
														<div class="product-img fl" style="background-image: url('{{asset($label['product']['cover'])}}');background-position: center;background-size: cover">
															{{--<img src="" />--}}
														</div>
														<div class="product-content fr">
															<h1 class="product-name">{{ $first_p['name'] }}</h1>
															<div class="product-label">
																<span>{{$label['product']['product_name']}}</span>
															</div>
															<div class="product-price">
		...
		<div class="bottom-nav">
			...
			@if(isset($_COOKIE['login_type']))
				<div class="bottom-nav-item mui-pull-left" id="login_type">
						<i id="offCanvasShow">
			...
			@else
				<div class="bottom-nav-item" id="login_person" >
					<a href="/login">
						<i id="offCanvasShow" class="mui-icon mui-icon-bars mui-pull-left hide"></i>
						<div class="bottom-nav-icon icon-person"></div>
						<span class="bottom-nav-text">个人中心</span>
					</a>
				</div>
