	...
	<div id="slider" class="mui-slider mui-fullscreen">
		<div id="sliderSegmentedControl" class="mui-scroll-wrapper mui-slider-indicator mui-segmented-control mui-segmented-control-inverted">
			<div class="nav-wrapper">
				<a class="mui-control-item mui-active" href="#item1mobile">在保保单</a>
						...
						@if(count($res)!=0)
							@foreach($res as $value)
								@if(date('Y-m-d',strtotime($value['start_time']))!=date('Y-m-d',time()))						
									...
									<a href="{{config('view_url.channel_target_url')}}warranty_info" id="warranty_info_y">	
										<div class="slip-left">
											<div class="slip-manager">
													<div >
														<span class="slip-manager-top">韵达快递保·人身意外综合保险</span>
													...
													<div class="slip-manager-nei">
														<span class="slip-manager-bot size" >保单号:<span class="slip-manager-bot-left">{{$value['warranty_code']}}</span></span>
														<div style="margin-top: .1rem;">
