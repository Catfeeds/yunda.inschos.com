                        ...
                        <div class="main-classify-recommend">
                            ...
                            <a class="more" href="/ins/ins_info/{{$label['product']['ty_product_id']}}" target="_blank">
                                <div class="main-recommend-content clearfix">
									@if(empty($label['product']['cover']))
										<div class="main-recommend-content-img" style="background-image: url('/r_backend/v2/img/396658748210103920.jpg');background-size: cover;background-position: center">
											{{--<img src="" alt="">--}}
										</div>
									@else
