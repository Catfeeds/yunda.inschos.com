	...
	<body>
		<div class="main">
			...
			<div class="mui-content">
				<div class="mui-scroll-wrapper">
					<div class="mui-scroll">
						<div class="applicant-wrapper">
							...
							{{--<ul class="applicant-parttwo">--}}
								{{--<li>--}}
									{{--<span class="name">受益人类别</span><input type="text" readonly value=""/>--}}
								{{--</li>--}}
								{{--<li>--}}
									{{--<span class="name">投保日期</span><input type="text" readonly value="" />--}}
								{{--</li>--}}
							{{--</ul>--}}
							{{--<div class="division"></div>--}}
							{{--<ul>--}}
								{{--<li>--}}
									{{--<span class="name">购买产品</span><input type="text" readonly value="" />--}}
								{{--</li>--}}
							{{--</ul>--}}
				...
				<div class="buttonbox">
					<button class="btn btn-next" onclick="insureSubmit()">下一步</button>
				</div>
			</div>
		</div>
