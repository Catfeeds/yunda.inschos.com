				...
				<div class="mui-content" style="background-color: #efeff4;">
					<div id="slider1" class="swipe">
						<div class="shixiao">
							...
							<div class="shixiao-head1">
								<span class="slip-manager-bot size" >被保人证件号:<span class="slip-manager-bot-left">{{$res['channel_user_info']['channel_user_code']}}</span></span>
							</div>
							<br/>
						</div>
						<div class="color"></div>
									...
									<div class="slip-manager">
										...
										<div class="slip-manager-nei">
											...
											<div style="margin-top: .16rem;">
												<span class="slip-manager-bot size" >保险期限:<span class="slip-manager-bot-left">当日上工时间至&nbsp;&nbsp;23:59:59</span></span>
											</div>
											<div style="margin-top: .16rem;">
												<span class="slip-manager-bot size" >投保单号:<span class="slip-manager-bot-left">{{$res['order']['order_code']}}</span></span>
											</div>
										</div>
									</div>
								</div>
