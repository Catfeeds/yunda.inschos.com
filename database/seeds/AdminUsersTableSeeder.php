...
//        ]);
        ...
        $yunda_id = DB::table('admin_users')->insertGetId(
            [
                'name' => 'yunda',
                'display_name' => '韵达业管',
                'email' => 'yunda'.'@inschos.com',
                'password' => bcrypt('123qwe'),
            ]
        );
        $douwan_id = DB::table('admin_users')->insertGetId(
            [
                'name' => 'douwan',
                'display_name' => '斗腕业管',
                'email' => 'douwan'.'@inschos.com',
                'password' => bcrypt('123qwe'),
            ]
        );
        ...
        $yunda_role_id = DB::table('roles')->insertGetId(
            [
                'name' => 'yunda',
                'display_name' => '业管专员权限',
                'description' => '业管专员相关权限',
        ...
        $douwan_role_id = DB::table('roles')->insertGetId(
            [
                'name' => 'douwan',
                'display_name' => '业管专员权限',
                'description' => '业管专员相关权限',
