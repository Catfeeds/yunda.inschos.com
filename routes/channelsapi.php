...
Route::group(['prefix' => '/channelsapi','namespace'=>'ChannelsApiControllers'],function(){
    ...
    //查询每天可以签约的人
    Route::any('selContractInfo', 'ChannelInfosController@selContractInfo');
    //微信支付代扣
    Route::any('do_insure_wechat_pay', 'ChannelInfosController@doInsureWechatPay');
	 //todo 测试出单操作
    ...
    Route::any('warranty_list_auto', 'ChannelInfosController@warrantyListAuto');
    Route::any('issue_list_auto', 'ChannelInfosController@issueListAuto');
    //需要验签
    ...
    Route::group(['middleware'=>'check.channels.api.token'],function(){
        ...
        //我的保险设置
        Route::any('/setup','IndexController@setup');//设置列表
        Route::any('/user_setup','IndexController@userSetup');//个人信息
        Route::any('/insure_setup','IndexController@insureSetup');//快递保设置
        Route::any('/insure_seting','IndexController@insureSeting');//自动投保设置
